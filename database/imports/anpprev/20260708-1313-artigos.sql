...
-- CTYPE_CODE correto: article.
-- Imagens: site-inst/public/images/anpprev/articles/*.webp, referenciadas por CONTENT.IMAGE_URL.
-- Metadados: CONTENT.AUTHOR_NAME, CONTENT.SOURCE_NAME, CONTENT.SOURCE_URL.
-- Downloads externos: WKSP_SINDICATTO.CONTENT_ATTACHMENT.
...
BEGIN
    ...
    DBMS_LOB.APPEND(v_contents, TO_CLOB(q'~<p style="text-align: justify;">Em recente decisão, o ministro Flávio Dino, do Supremo Tribunal Federal (STF), anulou decisão do Conselho Nacional de Justiça (CNJ) que havia mantido a pena de aposentadoria compulsória a um juiz estadual do Rio de Janeiro. O STF reconheceu que essa modalidade de sanção, que foi aplicada ao magistrado, foi extinta pela Emenda Constitucional (EC) 103/2019 (Reforma da Previdência) e que a tramitação do caso no Conselho violou o devido processo legal.</p><p style="text-align: justify;">Para o Ministro, com a extinção desse tipo de sanção (sanção administrativa aplicada aos magistrados), não faz sentido que esse grupo de servidores do Estado fiquem imunes a um sistema efetivo de responsabilidade disciplinar. A seu ver, as infrações graves devem ser punidas com a perda do cargo, que, por conta da garantia da vitaliciedade da magistratura, depende de ação judicial.</p><p style="text-align: justify;">No seu entendimento, a ação judicial deve ser apresentada diretamente no STF pela Advocacia-Geral da União, pois, somente o STF tem competência para analisar o conteúdo da decisão administrativa do CNJ.</p><p style="text-align: justify;">Nesse contexto, é importante destacar que a atribuição de promover a competente ação judicial de perda de cargo de membro da Magistratura foi assumida pela Advocacia Geral da União, órgão que congrega os Membros da Advocacia Pública Federal.</p><p style="text-align: justify;">Essa enorme responsabilidade, de promover ação de perda de cargo de magistrado condenado disciplinarmente, bem como a de recompor o erário quanto a eventuais prejuízos causados por sua atuação ilícita, contrasta com a lamentável carência de garantias institucionais dos membros da Advocacia Pública.</p><p style="text-align: justify;">No caso, a carreira promotora destas ações não possui sequer a garantia mínima da exclusividade do exercício de suas funções por seus membros. É dizer, em outras palavras, que a depender do chefe do Poder Executivo em exercício e a partir dos seus critérios, em tese, poderá haver ações desta modalidade, de sensibilíssima análise, sendo ajuizadas por advogados privados que estejam ocupando temporariamente cargos públicos dentro da Advocacia Geral da União.</p><p style="text-align: justify;">A possibilidade de deixar Magistrados à mercê de vingança privada; ou mesmo, a possibilidade de Membros da Advocacia Pública Federal tornarem-se vítimas de perseguições de autoridades apenadas ou que estejam em curso de apuração de irregularidades, exige uma reflexão detalhada da repercussão desta, sem dúvidas, moralizadora decisão do STF, que, entretanto, deve avançar mais para que as autênticas intenções republicanas não morram na praia e tenham eficácia mínima.</p><p style="text-align: justify;">Uma resposta~'));
    DBMS_LOB.APPEND(v_contents, TO_CLOB(q'~ imediata para parte dessas preocupações da Advocacia Pública está dentro da governabilidade da própria Corte Constitucional. Estamos falando da Proposta da Súmula Vinculante (PSV) Nº 18.</p><p style="text-align: justify;">A PSV Nº 18 – STF consagra a tese de que o exercício das funções da Advocacia Pública Federal constitui atividade exclusiva dos seus integrantes efetivos, a teor dos artigos 131 e 132 da Constituição Federal de 1988, tendo com redação seguinte teor: “O exercício das funções da Advocacia Pública, na União, nos Estados e nos Municípios, nestes onde houver, constitui atividade exclusiva dos seus integrantes efetivos, a teor dos artigos 131 e 132 da Constituição Federal de 1988”.</p><p style="text-align: justify;">A Proposta de Súmula Vinculante nº 18 está madura para julgamento já contando com a manifestação favorável da Procuradoria Geral da República (Parecer nº 772) e do Advogado Geral da União (maio de 2016), restando, no presente momento, ser colocada em pauta para votação.</p><p style="text-align: justify;">A publicação da referida Súmula Vinculante permite blindar de interferências indevidas o exercício republicano das atribuições dos Advogados Públicos nas suas várias áreas de atuação, principalmente no exame criterioso da promoção da competente ação judicial de perda de cargo de membro da Magistratura.</p>~'));
    ...
    INSERT INTO WKSP_SINDICATTO.CONTENT (
        ...
        TO_DATE('26/03/2026', 'DD/MM/YYYY'),
        TO_DATE('26/03/2026', 'DD/MM/YYYY'),
        q'~Artigo: Ação de Perda de Cargo de Magistrados e a Vulnerabilidade dos Advogados Públicos por Falta de Prerrogativas Institucionais Mínimas~',
        q'~/images/anpprev/articles/acao-de-perda-de-cargo-de-magistrados-e-a-vulnerabilidade-dos-advogados-publicos-por-falta-de-prerrogativas-institucionais-minimas.webp~',
        q'~acao-de-perda-de-cargo-de-magistrados-e-a-vulnerabilidade-dos-advogados-publicos-por-falta-de-prerrogativas-institucionais-minimas.webp~',
        SYSTIMESTAMP,
        q'~Silton Bezerra~',
        q'~Procurador Federal~',
        q'~https://anpprev.org.br/conteudo/5368/acao-de-perda-de-cargo-de-magistrados-e-a-vulnerabilidade-dos-advogados-publicos-por-falta-de-prerrogativas-institucionais-minimas~'
    );
...
BEGIN
    ...
    INSERT INTO WKSP_SINDICATTO.CONTENT (
        ...
        TO_DATE('01/07/2021', 'DD/MM/YYYY'),
        TO_DATE('01/07/2021', 'DD/MM/YYYY'),
        q'~Artigo: A Advocacia Pública e as atividades exclusivas de Estado~',
        q'~/images/anpprev/articles/a-advocacia-publica-e-as-atividades-exclusivas-de-estado.webp~',
        q'~a-advocacia-publica-e-as-atividades-exclusivas-de-estado.webp~',
        SYSTIMESTAMP,
        q'~Luiz Alberto dos Santos~',
        q'~ANPPREV~',
        q'~https://anpprev.org.br/conteudo/1109/a-advocacia-publica-e-as-atividades-exclusivas-de-estado~'
    );

    INSERT INTO WKSP_SINDICATTO.CONTENT_ATTACHMENT (
        CONTENT_ID,
        SORT_ORDER,
        TITLE,
        FILE_URL,
        ...
        C.ID,
        10,
        q'~Estudo ANPPREV - Carreiras Exclusivas~',
        q'~https://anpprev.org.br/download.php?idm=12255&f=uploads/20220130204526_estudo-anpprev-carreiras-exclusivas-150621--281-29.pdf~',
        q'~20220130204526_estudo-anpprev-carreiras-exclusivas-150621--281-29.pdf~',
        q'~application/pdf~',
        'Y'
      FROM WKSP_SINDICATTO.CONTENT C
     WHERE C.TENANT_CODE = 'anpprev'
       AND C.CTYPE_CODE = 'article'
       AND C.SLUG = q'~a-advocacia-publica-e-as-atividades-exclusivas-de-estado~';
...
BEGIN
    ...
    INSERT INTO WKSP_SINDICATTO.CONTENT (
        ...
        q'~/images/anpprev/articles/reforma-sindical.webp~',
        q'~reforma-sindical.webp~',
        SYSTIMESTAMP,
        NULL,
        q'~Queiroz Assessoria Parlamentar~',
        q'~https://anpprev.org.br/conteudo/1108/reforma-sindical~'
    );
...
BEGIN
    DBMS_LOB.CREATETEMPORARY(v_contents, TRUE);
    DBMS_LOB.APPEND(v_contents, TO_CLOB(q'~<p style="text-align: justify;">O resultado da votação da reforma da Previdência pode ser explicado a partir da composição do Congresso, de perfil liberal e fiscalista, do ambiente de crise fiscal do Estado brasileiro, além da dedicação exclusiva do residente da Câmara e da equipe econômica à aprovação da matéria.</p><p style="text-align: justify;">Para explicar a questão de fundo, que é o perfil político do Congresso eleito em 2018, vamos organizar o raciocínio em torno da narrativa em moda, que divide os parlamentares entre representantes da “nova” e da “velha” política.</p><p style="text-align: justify;">A chamada “nova política”, nessa perspectiva, seria representada pelos “novos” parlamentares, de perfil liberal e fiscalista, eleitos com apoio das redes sociais, a partir de um discurso moralista de combate à corrupção e de eficiência do gasto público.</p><p style="text-align: justify;">Esses “novos” parlamentares, como regra, estão distribuídos nos partidos do centro à extrema direita do espectro político, e, como exceção, em partidos de centro-esquerda, como PDT, PSB e Cidadania.</p><p style="text-align: justify;">Para eles, quem garante a justiça é a eficiência da economia, que por sua vez gera emprego renda, e o esforço individual das pessoas, responsável por criar as condições de empregabilidade, e não as políticas públicas ofertadas pelo Estado. É uma visão meritocrática e individualista, do tipo “a cada um segundo sua capacidade”.</p><p style="text-align: justify;">Por isso, essa parcela do Parlamento apoia as reformas fiscais e liberais, como esta da Previdência, por convicção.</p><p style="text-align: justify;">Os chamados representantes da “velha” política, vistos de forma negativa pela narrativa em voga, seriam os “reeleitos”, porém divididos em dois grupos: um formado pelos partidos de esquerda; e outro representado pelo “centrão”.</p><p style="text-align: justify;">O primeiro grupo, de esquerda, também pode ser classificado em dois tipos de parlamentares: os gastadores de recursos públicos (perdulários) e os que usam o Estado para sobreviver politicamente.</p><p style="text-align: justify;">Para esse grupo, a realização da justiça social depende de condições materiais, de igualdade de oportunidades e de políticas públicas do Estado. Sem essa proteção coletiva, o segmento pobre não teria oportunidade. Trata-se, portanto, de uma visão solidária, do tipo “a cada um segundo sua necessidade”.</p><p style="text-align: justify;">Esses grupos, por serem supostamente intervencionistas na economia e defensores do Estado máximo, seriam contrários a qualquer tipo de reforma que reduzisse o gasto público.</p><p style="text-align: justify;">O segundo grupo, formado por parlamentares do “centrão”, seria a tropa do “toma-lá-dácá”, sem qualquer compr~'));
    DBMS_LOB.APPEND(v_contents, TO_CLOB(q'~omisso programático. São vistos como “sanguessugas”, que condicionam o apoio às reformas à troca de recursos do orçamento, mesmo pertencendo a partidos de visão liberal e fiscalista.</p><p style="text-align: justify;">O “centrão”, apresentado como “fisiológico” perante a opinião pública e temendo ser responsabilizado por eventual colapso das contas públicas, utilizou uma estratégia inteligente: exigir mudança no conteúdo da reforma, para “demonstrar sensibilidade social”, mas sem abrir mão da liberação das emendas parlamentares.</p><p style="text-align: justify;">A estratégia funcionou. O governo cedeu no conteúdo, abrindo mão do regime de capitalização, do Benefício de Prestação Continuada (BPC) e da mudança na aposentadoria dos trabalhadores rurais, e ainda teve que liberar as emendas desse grupo.</p><p style="text-align: justify;">Vale lembrar que a estratégia funcionou também porque a esquerda bateu fortemente  naqueles pontos, considerados perversos para com os mais pobres, com grande repercussão na mídia comercial e nas redes sociais.</p><p style="text-align: justify;">Esses parlamentares do “centrão”, por pertencerem a partidos conservadores e de visão liberal fiscal, mesmo sem maiores convicções, não teriam alternativa a não ser apoiar a reforma.</p><p style="text-align: justify;">Uma estratégia pragmática num momento em que ela [a reforma] passou a ter apoio na opinião pública, além de sempre ter sido defendida por seus aliados no mercado, na mídia e no governo.</p><p style="text-align: justify;">As concessões em termos de conteúdo, embora tímidas, ajudaram na formação de maioria em outros partidos, porque deram aos parlamentares refratários o argumento de terem melhorado a reforma. Contudo, foi a liberação das emendas que motivou o “centrão” a votar em favor do texto.</p><p style="text-align: justify;">Por essa leitura, com exceção da esquerda, que votaria contra a agenda de reformas com esse viés fiscal, todos os demais votariam a favor, incluindo os “novos”, por convicção, e os do “centrão” por sobrevivência.</p><p style="text-align: justify;">Com um Congresso majoritariamente alinhado com a visão liberal fiscal – e num ambiente marcado por forte risco de colapso nas contas públicas, que expõe de modo dramático a necessidade de equilíbrio nas contas públicas – as condições para aprovar agendas com esse escopo seriam facilitadas.</p><p style="text-align: justify;">O fato de o orçamento estar congelado, em termos reais, e de a despesa previdenciária ser a maior, após a dos juros das dívidas interna e externa, facilitou a estratégia do governo, do mercado e da mídia de jogarem luzes sobre o crescimento da despesa previdenciária, o que passou para a sociedade a percepção da necessidade e urgência da reforma.</p><p style="text-align: justify;"~'));
    DBMS_LOB.APPEND(v_contents, TO_CLOB(q'~>Por fim, foi decisiva a determinação do presidente da Câmara e da equipe econômica em concentrar esforços na reforma. O envolvimento do deputado Rodrigo Maia, conhecidamente como um homem pró-mercado, foi de tal ordem que ele assumiu não apenas a articulação com os líderes partidários, mas também participou da negociação de conteúdo. Funcionou, na prática, como líder do governo, embora tenha dito que se tratava de uma agenda do Congresso.</p><p style="text-align: justify;">Esse tende a ser o padrão de votação em matérias da agenda liberal e fiscal do governo.</p><p style="text-align: justify;">Terá a esquerda contra, mas contará com os “novos” sem custo e com o “centrão”, ainda que tenha que pagar pedágio via liberação de emendas parlamentares.</p><p style="text-align: justify;"> </p>~'));
    ...
    INSERT INTO WKSP_SINDICATTO.CONTENT (
        ...
        q'~/images/anpprev/articles/para-entender-a-votacao-da-reforma-da-previdencia.webp~',
        q'~para-entender-a-votacao-da-reforma-da-previdencia.webp~',
        SYSTIMESTAMP,
        NULL,
        q'~Queiroz Assessoria Parlamentar~',
        q'~https://anpprev.org.br/conteudo/1106/para-entender-a-votacao-da-reforma-da-previdencia~'
    );
...
BEGIN
    ...
    INSERT INTO WKSP_SINDICATTO.CONTENT (
        ...
        q'~/images/anpprev/articles/a-logica-da-reforma-administrativa-do-governo-bolsonaro.webp~',
        q'~a-logica-da-reforma-administrativa-do-governo-bolsonaro.webp~',
        SYSTIMESTAMP,
        NULL,
        q'~Queiroz Assessoria Parlamentar~',
        q'~https://anpprev.org.br/conteudo/1107/a-logica-da-reforma-administrativa-do-governo-bolsonaro~'
    );
...
BEGIN
    ...
    INSERT INTO WKSP_SINDICATTO.CONTENT (
        ...
        q'~/images/anpprev/articles/a-estabilidade-do-servidor-publico.webp~',
        q'~a-estabilidade-do-servidor-publico.webp~',
        SYSTIMESTAMP,
        q'~Thelma Goulart~',
        NULL,
        q'~https://anpprev.org.br/conteudo/1104/a-estabilidade-do-servidor-publico~'
    );
...
BEGIN
    DBMS_LOB.CREATETEMPORARY(v_contents, TRUE);
    DBMS_LOB.APPEND(v_contents, TO_CLOB(q'~<p style="text-align: justify;">27 anos! Mais de um quarto de século!</p><p style="text-align: justify;">L e m b r o - m e bem de uma cena: estávamos com o jornal Correio Braziliense nas mãos quando o Procurador-Geral à época, Dr. Francisco Adalberto da Nóbrega, perguntou porque estávamos tão aborrecidos. Dissemos: “Olha esta notícia. Estamos próximos à isenção na tabela do imposto de renda”. Depois de sermos por anos os “Príncipes da República”, vimos nosso salário ser achatado vergonhosamente. Chamou-nos ele às falas: por que vocês não se unem? Não adianta vozes soltas reclamando, vocês precisam de uma associação, forte, para defender suas bandeiras.</p><p style="text-align: justify;">E foi assim, com o auxílio desse ilustre anppreviano honorário, que nossa colega Meire Monteiro ousou criar a Anpprev. Concretizada, logo arregimentou a categoria em torno dos ideais que desde então nortearam a Associação. E conseguimos respeito e novamente termos salários compatíveis com a importância do trabalho que desenvolvemos.</p><p style="text-align: justify;">Logo fizemos o primeiro congresso, em Caldas Novas, Goiás. Em 15 dias organizamos o evento, com presença expressiva dos associados de todo Brasil. E, no meio das palestras, o imprevisto aconteceu: acabou a energia elétrica no resort. O calor comum à região era intenso. O ar condicionado, claro, inoperante. E ninguém saiu do auditório. Queríamos ouvir e sermos ouvidos. O então presidente do INSS, Cesar Gasparin, presidente da Anfip, disse ao microfone que nunca tinha presenciado um tal interesse de uma categoria nos destinos do órgão e da carreira. Foi, realmente, impressionante.</p><p style="text-align: justify;">Então, colegas, se estamos hoje, como os demais servidores públicos, vendo nossas prerrogativas e conquistas ameaçadas, vamos à luta! Somos importantes para o Estado. E nós, os aposentados, sabemos quanto suor foi preciso para vermos implantadas a AGU, a PGF, a modernização das procuradorias. Ainda há vida depois da aposentadoria: não vamos ficar inertes, descansando sobre os louros.</p><p style="text-align: justify;">Nesses 27 anos contamos, sempre, com o apoio da Anpprev, que ao longo dos quais se fez respeitada, abrindo portas dos gabinetes institucionais, levando nossos pleitos às autoridades. Vamos dar a contrapartida: nos engajarmos nas campanhas (como agora, contra a Reforma da Previdência, no que ela tem de perniciosa), sempre que para isto convocados.</p><p style="text-align: justify;">Mas, como já dito, ninguém entra em um mesmo rio uma segunda vez, pois quando isso acontece já não se é o mesmo, assim como as águas já serão outras. Tudo mudou ao longo desses anos. Nós, a administração pública, a Anpprev. Nada é permanente, exceto a mudança.</p><p style="text-align: justify;">E o jornal ~'));
    DBMS_LOB.APPEND(v_contents, TO_CLOB(q'~já distribuído pela atual diretoria mostrou as conquistas feitas, no campo das parcerias institucionais, na representação da categoria, nos convênios firmados. Temos procurado ficar à altura das gestões anteriores, nos que elas tiveram de melhor, mas trazendo nosso jeito de ser diferente, cumprindo as promessas de campanha.</p><p style="text-align: justify;">Esta gestão, onde alguns componentes são anpprevianos de primeira hora, vem demonstrando domínio e conhecimento dos problemas que atingem os associados. O caminho buscado do equilíbrio e da satisfação coletiva está sendo traçado com idealismo e mentes sintonizadas.</p><p style="text-align: justify;">Sempre haverá aqueles descontentes. Há apenas uma forma de evitar críticas: não fazer nada, não dizer nada, não ser nada. E a omissão não é uma característica desta gestão. Confiamos em que, juntos com os associados, poderemos alcançar ainda muitas vitórias.</p><p style="text-align: justify;">Parabéns à Anpprev e todos os Anpprevianos! Vida longa à Anpprev!</p><p style="text-align: justify;"> </p>~'));
    ...
    INSERT INTO WKSP_SINDICATTO.CONTENT (
        ...
        q'~/images/anpprev/articles/27-anos-de-anpprev.webp~',
        q'~27-anos-de-anpprev.webp~',
        SYSTIMESTAMP,
        q'~Vera Sarmet~',
        NULL,
        q'~https://anpprev.org.br/conteudo/1105/27-anos-de-anpprev~'
    );
...
BEGIN
    DBMS_LOB.CREATETEMPORARY(v_contents, TRUE);
    DBMS_LOB.APPEND(v_contents, TO_CLOB(q'~<p><a href="https://anpprev.org.br/download.php?idm=125&amp;f=uploads/anp_data/editor/boletim_diap_nov_2001.pdf" rel="noopener noreferrer" target="_blank" title="Clique para fazer download do arquivo">Clique aqui </a>para ver o boletim</p>~'));
    ...
    INSERT INTO WKSP_SINDICATTO.CONTENT (
        ...
        q'~/images/anpprev/articles/os-trabalhadores-e-a-fiscalizacao-dos-fundos-de-pensao.webp~',
        q'~os-trabalhadores-e-a-fiscalizacao-dos-fundos-de-pensao.webp~',
        SYSTIMESTAMP,
        NULL,
        q'~Boletim do DIAP~',
        q'~https://anpprev.org.br/conteudo/1093/os-trabalhadores-e-a-fiscalizacao-dos-fundos-de-pensao~'
    );
    ...
    INSERT INTO WKSP_SINDICATTO.CONTENT_ATTACHMENT (
        ...
        C.ID,
        10,
        q'~Boletim DIAP - Novembro de 2001~',
        q'~https://anpprev.org.br/download.php?idm=125&f=uploads/anp_data/editor/boletim_diap_nov_2001.pdf~',
        q'~boletim_diap_nov_2001.pdf~',
        q'~application/pdf~',
        'Y'
      FROM WKSP_SINDICATTO.CONTENT C
     WHERE C.TENANT_CODE = 'anpprev'
       AND C.CTYPE_CODE = 'article'
       AND C.SLUG = q'~os-trabalhadores-e-a-fiscalizacao-dos-fundos-de-pensao~';
...
BEGIN
    ...
    INSERT INTO WKSP_SINDICATTO.CONTENT (
        ...
        q'~/images/anpprev/articles/o-fator-previdenciario.webp~',
        q'~o-fator-previdenciario.webp~',
        SYSTIMESTAMP,
        q'~Meire Lúcia G. M. M. Coelho~',
        NULL,
        q'~https://anpprev.org.br/conteudo/1092/o-fator-previdenciario~'
    );
...
BEGIN
    ...
    INSERT INTO WKSP_SINDICATTO.CONTENT (
        ...
        q'~/images/anpprev/articles/a-justica-prospectiva-na-seguridade-social.webp~',
        q'~a-justica-prospectiva-na-seguridade-social.webp~',
        SYSTIMESTAMP,
        q'~Meire Lucia Gomes Monteiro Mota Coelho~',
        NULL,
        q'~https://anpprev.org.br/conteudo/1091/a-justica-prospectiva-na-seguridade-social~'
    );
...
SELECT COUNT(*) AS total_anexos_artigos_anpprev
FROM WKSP_SINDICATTO.CONTENT_ATTACHMENT A
JOIN WKSP_SINDICATTO.CONTENT C ON C.ID = A.CONTENT_ID
WHERE C.TENANT_CODE = 'anpprev'
  AND C.CTYPE_CODE = 'article';
