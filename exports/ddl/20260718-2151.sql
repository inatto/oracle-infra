...
(
    ...
    INTRO_HTML  CLOB,
    RESULTS_AT  TIMESTAMP(6) WITH TIME ZONE,
...
create index IX_VOTING_TENANT_PERIOD
    on VOTING (TENANT_CODE, IS_ACTIVE, SYS_EXTRACT_UTC("STARTS_AT"), SYS_EXTRACT_UTC("ENDS_AT"))
/
...
(
    ...
    ANSWERED_AT        TIMESTAMP(6) WITH TIME ZONE default SYSTIMESTAMP not null,
